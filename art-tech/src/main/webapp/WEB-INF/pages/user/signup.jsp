...
<html lnag="ko">
			...
			$(document).ready(function(){
						...
						$.ajax({
							...
							success : function(data){ 
								...
								if(data == '0'){ //아이디 사용 가능
									...
									document.querySelector('#user_idCheck').style.color = "#FF0000";
									document.querySelector('#user_idCheck').style.display = "block";
				...
				$('#user_password').keyup(function(){
					...
					if($('#user_password').val() == "") {
						...
						pwImg.src = "${pageContext.request.contextPath}/static/img/signup/m_icon_not_use.png";
				        ...
				        pwMsg.style.display = "block";
						pwImg.src = "${pageContext.request.contextPath}/static/img/signup/m_icon_safe.png";
					}
				})
				...
				$('#user_rePassword').keyup(function(){
					if($('#user_password').val() != $('#user_rePassword').val()) {
						...
						rePswd_img.src = "${pageContext.request.contextPath}/static/img/signup/m_icon_check_enable.png";
				...
				$('#smsAuth').click(function(){
					...
					$.ajax({
						type: "POST",
						url : "${pageContext.request.contextPath}/auth/smsAuth",
						method : 'post',
						data : {
							"phone" : $('#mobile').val()
						},
				...
				$('#emailAuth').click(function(){
					$.ajax({
						type: "POST",
						url : "${pageContext.request.contextPath}/auth/emailAuth",
						method : 'post',
						data : {
							"email" : $('#email').val()
						},
				...
				$('#easy_password').keyup(function(){
					...
					if($('#easy_password').val() == "") {
						...
						pwImg1.src = "${pageContext.request.contextPath}/static/img/signup/m_icon_not_use.png";
				        ...
				        pwMsg1.style.display = "block";
						pwImg1.src = "${pageContext.request.contextPath}/static/img/signup/m_icon_safe.png";
					}
				})
				...
				$('#reEasy_password').keyup(function(){
					if($('#easy_password').val() != $('#reEasy_password').val()) {
						...
						pwImg2.src = "${pageContext.request.contextPath}/static/img/signup/m_icon_check_enable.png";
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <!-- content-->
            <div id="content">
            	<form action="${pageContext.request.contextPath}/member/signup" onsubmit="return signUpFormCheck()" method="post"> 
            	<input type="hidden" name="kakao_id" value="${kakao_id}">
	                ...
	                <div>
	                    ...
	                    <span class="box int_name">
	                        <input type="text" id="user_id" name="userId" class="int" maxlength="20">
	                    </span>
	                ...
	                <div>
	                    ...
	                    <span class="box int_pass">
	                        <input type="password" id="user_password" name="password" class="int" maxlength="20">
	                        <span id="alertTxt" class="user_password">사용불가</span>
	                        <img src="${pageContext.request.contextPath}/static/img/signup/m_icon_pass.png" id="pswd_img" class="pswdImg">
	                    </span>
	                ...
	                <div>
	                    ...
	                    <span class="box int_pass_check">
	                        ...
	                        <img src="${pageContext.request.contextPath}/static/img/signup/m_icon_check_disable.png" id="rePswd_img" class="pswdImg">
	                    </span>
	                ...
	                <div>
	                    ...
	                    <span class="box int_name">
	                        <input type="password" id="jumin_no" name="juminNo" class="int" maxlength="20">
	                    </span>
	                ...
	                <div>
	                    ...
	                    <span class="box int_pass">
	                        <input type="password" id="easy_password" name="easyPassword" class="int" maxlength="20">
	                        <span id="alertTxt" class="easy_password">사용불가</span>
	                        <img src="${pageContext.request.contextPath}/static/img/signup/m_icon_pass.png" id="pswd1_img1" class="pswdImg">
	                    </span>
	                ...
	                <div>
	                    ...
	                    <span class="box int_pass_check">
	                        ...
	                        <img src="${pageContext.request.contextPath}/static/img/signup/m_icon_check_disable.png" id="pswd2_img1" class="pswdImg">
	                    </span>
					...
					<div>
		                ...
		                <div>
		                    ...
		                    <span class="box int_name">
		                        <input type="text" class="int" name="addr1Load" id="sample4_roadAddress" placeholder="우편번호 찾기를 눌러주세요." required="required" readonly>
		                    </span>
		                    <span class="error_next_box"></span>
		                </div>
		                ...
		                <div>
		                    ...
		                    <span class="box int_name">
		                        <input type="text" class="int" name="addr1Jibun" id="sample4_jibunAddress" placeholder="우편번호 찾기를 눌러주세요." required="required" readonly>
		                    </span>
					...
					<!-- 카카오 알림 받을건지 -->
	                <div>
	                    <h3 class="join_title"><label for="name">카카오톡 알림을 받으시겠습니까?<br>(회원가입 후 마이페이지에서 카카오 연동을 진행하셔야 합니다.)</label></h3>
	                    <span>
	                    	<input type="radio" name="receiveKakaoYn" value="Y" > <label for="name">수신</label>
	                    	<input type="radio" name="receiveKakaoYn" value="N"> <label for="name">수신 거부</label>
	                    </span>
	                    <span class="error_next_box"></span>
	                </div>
