...
<body>
	<!-- Start Footer -->
    <footer class="bg-secondary pt-4" class="footer">
    ...
    <!-- Isotope -->
    <script src="${pageContext.request.contextPath}/static/js/isotope.pkgd.js"></script>
    <!-- Page Script -->
    <script>
    ...
    <!-- Templatemo -->
    <script src="${pageContext.request.contextPath}/static/js/templatemo.js"></script>
    <!-- Custom -->
